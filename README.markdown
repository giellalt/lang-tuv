...
This directory contains source files for the Turkana language morphology
...
-   <https://giellalt.uit.no/lang/tuv/index.html> (analyser)
...
The Turkana language sources can be acquired using [giella SVN
